...
// }
 ...
 function drawTriangle3DUVmod(vertices, uv,n){
   //var n = 3; //number of vertices
 ...
 function drawTriangle3DUVNormal(vertices, uv, normals){ //callin this one now for the renderfast
   ...
   gl.enableVertexAttribArray(a_UV);
   var normalBuffer = gl.createBuffer(); //this??
   if(!normalBuffer){
      console.log('Failed to create the buffer object');
      return -1;
   }
